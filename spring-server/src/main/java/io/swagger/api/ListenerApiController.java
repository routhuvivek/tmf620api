...
import io.swagger.model.CatalogAttributeValueChangeEvent;
...
import io.swagger.model.CatalogStateChangeEvent;
import io.swagger.model.CategoryAttributeValueChangeEvent;
import io.swagger.model.CategoryCreateEvent;
import io.swagger.model.CategoryDeleteEvent;
import io.swagger.model.CategoryStateChangeEvent;
...
import io.swagger.model.ProductSpecificationAttributeValueChangeEvent;
import io.swagger.model.ProductSpecificationCreateEvent;
import io.swagger.model.ProductSpecificationDeleteEvent;
import io.swagger.model.ProductSpecificationStateChangeEvent;
...
public class ListenerApiController implements ListenerApi {
    ...
    public ResponseEntity<EventSubscription> listenToCatalogAttributeValueChangeEvent(@ApiParam(value = "The event data" ,required=true )  @Valid @RequestBody CatalogAttributeValueChangeEvent data) {
    ...
    public ResponseEntity<EventSubscription> listenToCatalogStateChangeEvent(@ApiParam(value = "The event data" ,required=true )  @Valid @RequestBody CatalogStateChangeEvent data) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<EventSubscription>(objectMapper.readValue("{\"empty\": false}", EventSubscription.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<EventSubscription> listenToCategoryAttributeValueChangeEvent(@ApiParam(value = "The event data" ,required=true )  @Valid @RequestBody CategoryAttributeValueChangeEvent data) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<EventSubscription>(objectMapper.readValue("{\"empty\": false}", EventSubscription.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<EventSubscription> listenToCategoryStateChangeEvent(@ApiParam(value = "The event data" ,required=true )  @Valid @RequestBody CategoryStateChangeEvent data) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<EventSubscription>(objectMapper.readValue("{\"empty\": false}", EventSubscription.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<EventSubscription> listenToProductSpecificationAttributeValueChangeEvent(@ApiParam(value = "The event data" ,required=true )  @Valid @RequestBody ProductSpecificationAttributeValueChangeEvent data) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<EventSubscription>(objectMapper.readValue("{\"empty\": false}", EventSubscription.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<EventSubscription> listenToProductSpecificationStateChangeEvent(@ApiParam(value = "The event data" ,required=true )  @Valid @RequestBody ProductSpecificationStateChangeEvent data) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<EventSubscription>(objectMapper.readValue("{\"empty\": false}", EventSubscription.class), HttpStatus.NOT_IMPLEMENTED);
