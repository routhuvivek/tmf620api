...
import io.swagger.model.BundledProductOfferingOption;
import lombok.Data;
...
public class BundledProductOffering   {
  ...
  @OneToOne(targetEntity = BundledProductOfferingOption.class, cascade = CascadeType.ALL)
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, href, lifecycleStatus, name, bundledProductOfferingOption, baseType, schemaLocation, type);
  }
