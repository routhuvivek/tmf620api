...
public class ProductOfferingPrice   {
  ...
  @Valid
  @OneToMany(targetEntity = BundledProductOfferingPriceRelationship.class, cascade = CascadeType.ALL)
  ...
  @Valid
  @OneToMany(targetEntity = ProductOfferingPriceRelationship.class, cascade = CascadeType.ALL)
  ...
  @Valid
  @OneToMany(targetEntity = PricingLogicAlgorithm.class, cascade = CascadeType.ALL)
  ...
  @JsonProperty("tax")
  @Valid
  @OneToMany(targetEntity = TaxItem.class , cascade = CascadeType.ALL)
