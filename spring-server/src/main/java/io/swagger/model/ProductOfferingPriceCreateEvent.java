...
import io.swagger.model.ProductOfferingPriceCreateEventPayload;
...
public class ProductOfferingPriceCreateEvent   {
  @JsonProperty("event")
  private ProductOfferingPriceCreateEventPayload event = null;
  ...
  **/
  ...
  public ProductOfferingPriceCreateEvent eventTime(OffsetDateTime eventTime) {
  ...
  **/
  ...
  public ProductOfferingPriceCreateEvent timeOcurred(OffsetDateTime timeOcurred) {
